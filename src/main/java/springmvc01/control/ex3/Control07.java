...
public class Control07 {
  ...
  public String test01(HttpServletRequest request, HttpServletResponse response, HttpSession session) {
  ...
  public void test03(
      ...
      @RequestParam("age") String age, /*프론트 컨트롤러가 문자열을 자바 원시타입으로 자동변환해준다.*/
  ...
  /* @RequestParam 생략
   * => 파라미터 명이 변수명과 같고, 선택항목으로 만들고 싶다면 생략해도 된다.
   *    즉 생략하면 다음과 같다.
   *    @RequestParam(value="name",required=false) String name
   *    ==> String name
   */
  @RequestMapping("/ex3/test07")
  public void test07(String name, String age, boolean work) {
    System.out.println(name);
    System.out.println(age);
    System.out.println(work);
  }
